...
[dingdian]=bloodPress_1('C:\Users\sunming\Desktop\ABI\1.txt')  ;                                 %%收缩压

Ankle_left_dingdian=dingdian; 

[dingdian]=bloodPress_1( 'C:\Users\sunming\Desktop\ABI\2.txt');                                 %%收缩压

Ankle_right_dingdian=dingdian;

[dingdian]=bloodPress_1( 'C:\Users\sunming\Desktop\ABI\3.txt');                                %%收缩压

Brachial_left_dingdian=dingdian;

[dingdian]=bloodPress_1( 'C:\Users\sunming\Desktop\ABI\4.txt') ;                              %%收缩压
...
elseif(parameter(1,1)>=160)                                                                  %%加压    加压幅度？？？                                        
...
elseif(parameter(2,1)>=160)                                                         %%加压    加压幅度？？？                                       
...
elseif(parameter(3,1)>=160)                                                %%加压    加压幅度？？？
...
elseif(parameter(4,1)>=150)                                                    %%加压    加压幅度？？？
