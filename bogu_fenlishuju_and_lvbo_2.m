...
Max_maibobo_start=max([left_Ankle_start,right_Ankle_start,left_Brachial_start,right_Brachial_start]);
...
Ankle_left_bloodPress=Forecast_Systolic_pressure;                %%平均压

Ankle_left_Diastolic=Forecast_Diastolic_pressure;                   %%舒张压
...
Ankle_right_bloodPress=Forecast_Systolic_pressure;           %%平均压

Ankle_right_Diastolic=Forecast_Diastolic_pressure;             %%舒张压
...
Brachial_left_bloodPress=Forecast_Systolic_pressure;            %%平均压     

Brachial_left_Diastolic=Forecast_Diastolic_pressure;              %%舒张压
...
Brachial_right_bloodPress=Forecast_Systolic_pressure;           %%平均压 

Brachial_right_Diastolic  =Forecast_Diastolic_pressure;             %%舒张压
...
% left_Ankle_data2=diff(data);
% left_Ankle_data3=diff(left_Ankle_data2);
% 
% left_Ankle_data2=(round(left_Ankle_data2.*100))./100;
% left_Ankle_data3=(round(left_Ankle_data3.*100))./100;
% 
% left_Ankle_data3(abs(left_Ankle_data3)<0.00001)=0;
% 
...
while(i<=length(data)-100)
    ...
    if  ((data(i+30)<=data(i))&&(data(i+30)<=data(i+1))&&(data(i+30)<=data(i+2))&&(data(i+30)<=data(i+3))&&(data(i+30)<=data(i+4))&&...
        ...
        (data(i+30)<=data(i+56))&&(data(i+30)<=data(i+57))&&(data(i+30)<=data(i+58))&&(data(i+30)<=data(i+59))&&(data(i+30)<=data(i+60)))
                                      
                                                                                           %%   寻找波谷点，60可能为半个脉搏周期 
    
        if(count==0)
            
            left_Ankle_Point=[left_Ankle_Point,i+30];              %%  初始化该波谷点                
...
%                                                                                                                                                      %% 在另半个脉搏周期内又找到新的合适点
        if((count==1)&&(i+30>left_Ankle_Point(length(left_Ankle_Point))+60)&&(i+30<left_Ankle_Point(length(left_Ankle_Point))+130))
            ...
            left_Ankle_Point=[left_Ankle_Point,i+30];              %% 加入新波谷点                              
            
%             count=count+1;
        end
        
%         if((count==1)&&(i+30>left_Ankle_Point(length(left_Ankle_Point))+110))
...
%         if((count==1)&&(i+30>left_Ankle_Point(length(left_Ankle_Point))+110)&&(i+30<=left_Ankle_Point(length(left_Ankle_Point))+210))
%            left_Ankle_Point=[left_Ankle_Point,round((i+30+left_Ankle_Point(length(left_Ankle_Point)))/2)];
%            left_Ankle_Point=[left_Ankle_Point,i+30];
%         end
%         if((count==1)&&(i+30>left_Ankle_Point(length(left_Ankle_Point))+110))
%             
%             for temp_0301=left_Ankle_Point(length(left_Ankle_Point))+50:left_Ankle_Point(length(left_Ankle_Point))+110
%                 temp_sum=0;
%                 for kkk=-30:30 
%                 if(data(temp_0301)>=data(temp_0301+kkk))
%                      temp_sum=temp_sum+1;
%                 end
%                 end
...
%             end
%             
%            if(temp_0301==left_Ankle_Point(length(left_Ankle_Point))+110)
%               for temp_0301=left_Ankle_Point(length(left_Ankle_Point))+50:left_Ankle_Point(length(left_Ankle_Point))+110
%                   temp_sum=0;
%                   for kkk=-30:30 
%                   if(data(temp_0301)>=data(temp_0301+kkk))
...
plot(left_Ankle_Point,beifen_data(left_Ankle_Point),'ro');                        %% 绘制波谷点
...
% right_Ankle_data2=diff(data);
% right_Ankle_data3=diff(right_Ankle_data2);
% 
% right_Ankle_data2=(round(right_Ankle_data2.*100))./100;
% right_Ankle_data3=(round(right_Ankle_data3.*100))./100;
% 
% right_Ankle_data3(abs(right_Ankle_data3)<0.00001)=0;
% 
...
i=100;
while(i<=length(data)-100)                                            %前后截掉100点
    if  ((data(i+30)<=data(i))&&(data(i+30)<=data(i+1))&&(data(i+30)<=data(i+2))&&(data(i+30)<=data(i+3))&&(data(i+30)<=data(i+4))&&...
        (data(i+30)<=data(i+5))&&(data(i+30)<=data(i+6))&&(data(i+30)<=data(i+7))&&(data(i+30)<=data(i+8))&&(data(i+30)<=data(i+9))&&...
        (data(i+30)<=data(i+10))&&(data(i+30)<=data(i+11))&&(data(i+30)<=data(i+12))&&(data(i+30)<=data(i+13))&&(data(i+30)<=data(i+14))&&...
        (data(i+30)<=data(i+15))&&(data(i+30)<=data(i+16))&&(data(i+30)<=data(i+17))&&(data(i+30)<=data(i+18))&&(data(i+30)<=data(i+19))&&...
        ...
        if(count==0)
            ...
            right_Ankle_Point=[right_Ankle_Point,i+30];                 %%  初始化该波谷点         
...
%                                                                                                                                               %% 在另半个脉搏周期内又找到新的合适点
        if((count==1)&&(i+30>right_Ankle_Point(length(right_Ankle_Point))+60)&&(i+30<right_Ankle_Point(length(right_Ankle_Point))+130))
            ...
            right_Ankle_Point=[right_Ankle_Point,i+30];                 %% 加入新波谷点        
%             count=count+1;
        end
        
                 
%         if((count==1)&&(i+30>right_Ankle_Point(length(right_Ankle_Point))+110)&&(i+30<=right_Ankle_Point(length(right_Ankle_Point))+210))
...
%         end
%         if((count==1)&&(i+30>right_Ankle_Point(length(right_Ankle_Point))+110))
%             
%             for temp_0301=right_Ankle_Point(length(right_Ankle_Point))+50:right_Ankle_Point(length(right_Ankle_Point))+110
%                 temp_sum=0;
%                 for kkk=-30:30 
%                 if(data(temp_0301)>=data(temp_0301+kkk))
%                      temp_sum=temp_sum+1;
...
%             
%             
%             if(temp_0301==right_Ankle_Point(length(right_Ankle_Point))+110)
%               
%                for temp_0301=right_Ankle_Point(length(right_Ankle_Point))+50:right_Ankle_Point(length(right_Ankle_Point))+110
%                   temp_sum=0;
%                   for kkk=-30:30 
...
%         if((count==1)&&(i+30>right_Ankle_Point(length(right_Ankle_Point))+110)&&(i+30<2*right_Ankle_Point(length(right_Ankle_Point))+110-right_Ankle_Point(length(right_Ankle_Point)-1)))
%            right_Ankle_Point=[right_Ankle_Point,round((i+30+right_Ankle_Point(length(right_Ankle_Point)))/2)];
%            right_Ankle_Point=[right_Ankle_Point,i+30];
%         end
%         if((count==1)&&(i+30>2*right_Ankle_Point(length(right_Ankle_Point))+110-right_Ankle_Point(length(right_Ankle_Point)-1)))
...
plot(right_Ankle_Point,beifen_data(right_Ankle_Point),'ro')                             %% 绘制波谷点 
...
% left_Brachial_data2=diff(data);
% left_Brachial_data3=diff(left_Brachial_data2);
% 
% left_Brachial_data2=(round(left_Brachial_data2.*100))./100;
% left_Brachial_data3=(round(left_Brachial_data3.*100))./100;
% 
% left_Brachial_data3(abs(left_Brachial_data3)<0.00001)=0;
% 
...
while(i<=length(data)-100)                                                                                   %前后截掉100点
    if  ((data(i+30)<=data(i))&&(data(i+30)<=data(i+1))&&(data(i+30)<=data(i+2))&&(data(i+30)<=data(i+3))&&(data(i+30)<=data(i+4))&&...
       ...
       %(left_Brachial_data2(i+30)<=0)&&(left_Brachial_data2(i+31)<=0)&&(left_Brachial_data2(i+32)<=0)&&(left_Brachial_data2(i+33)<=0))
                                                                                                        %%   寻找波谷点，60可能为半个脉搏周期
       if(count==0)                                               
            left_Brachial_Point=[left_Brachial_Point,i+30];                   %%  初始化该波谷点    
            count=count+1;
       end
...
%                                                                                                                                                      %% 在另半个脉搏周期内又找到新的合适点
        if((count==1)&&(i+30>left_Brachial_Point(length(left_Brachial_Point))+60)&&(i+30<left_Brachial_Point(length(left_Brachial_Point))+130))
            ...
            left_Brachial_Point=[left_Brachial_Point,i+30];                  %%加入新波谷点
%             count=count+1;
        end
        
        
%         if((count==1)&&(i+30>left_Brachial_Point(length(left_Brachial_Point))+110)&&(i+30<=left_Brachial_Point(length(left_Brachial_Point))+210))
...
%         end
%         if((count==1)&&(i+30>left_Brachial_Point(length(left_Brachial_Point))+110))
%             for temp_0301=left_Brachial_Point(length(left_Brachial_Point))+50:left_Brachial_Point(length(left_Brachial_Point))+110
%                 temp_sum=0;
%                 for kkk=-30:30 
%                 if(data(temp_0301)>=data(temp_0301+kkk))
%                       temp_sum=temp_sum+1;
...
%             end
% 
%           if(temp_0301==left_Brachial_Point(length(left_Brachial_Point))+110)
%               for temp_0301=left_Brachial_Point(length(left_Brachial_Point))+50:left_Brachial_Point(length(left_Brachial_Point))+110
%                   temp_sum=0;
%                   for kkk=-30:30 
%                   if(data(temp_0301)>=data(temp_0301+kkk))
...
%         if((count==1)&&(i+30>left_Brachial_Point(length(left_Brachial_Point))+110)&&(i+30<2*left_Brachial_Point(length(left_Brachial_Point))+110-left_Brachial_Point(length(left_Brachial_Point)-1)))
%            left_Brachial_Point=[left_Brachial_Point,round((i+30+left_Brachial_Point(length(left_Brachial_Point)))/2)];
%            left_Brachial_Point=[left_Brachial_Point,i+30];
%         end
%         if((count==1)&&(i+30>2*left_Brachial_Point(length(left_Brachial_Point))+110-left_Brachial_Point(length(left_Brachial_Point)-1)))
...
plot(left_Brachial_Point,beifen_data(left_Brachial_Point),'ro');                        %%绘制波谷点
...
% right_Brachial_data2=diff(data);
% right_Brachial_data3=diff(right_Brachial_data2);
% 
% right_Brachial_data2=(round(right_Brachial_data2.*100))./100;
% right_Brachial_data3=(round(right_Brachial_data3.*100))./100;
% 
% right_Brachial_data3(abs(right_Brachial_data3)<0.00001)=0;
...
%        (right_Brachial_data2(i+30)<=0)&&(right_Brachial_data2(i+31)<=0)&&(right_Brachial_data2(i+32)<=0)&&(right_Brachial_data2(i+33)<=0))
        ...
        if(count==0)                                                                           %第三个点出了问题，想办法解决
            right_Brachial_Point=[right_Brachial_Point,i+30];                %%   初始化该波谷点  
            count=count+1;
        end 
                                                                                                          %% 在另半个脉搏周期内又找到新的合适点 
        if((count==1)&&(i+30>right_Brachial_Point(length(right_Brachial_Point))+60)&&(i+30<right_Brachial_Point(length(right_Brachial_Point))+130))
            ...
            right_Brachial_Point=[right_Brachial_Point,i+30];                %%加入新波谷点
...
%         if((count==1)&&(i+30>right_Brachial_Point(length(right_Brachial_Point))+110)&&(i+30<=right_Brachial_Point(length(right_Brachial_Point))+210))
...
%         end
%         if((count==1)&&(i+30>right_Brachial_Point(length(right_Brachial_Point))+110))
%             
%             for temp_0301=right_Brachial_Point(length(right_Brachial_Point))+50:right_Brachial_Point(length(right_Brachial_Point))+110
%                 temp_sum=0;
%                 for kkk=-30:30 
%                 if(data(temp_0301)>=data(temp_0301+kkk))
%                      temp_sum=temp_sum+1;
...
%             end
%             
%          if(temp_0301==right_Brachial_Point(length(right_Brachial_Point))+110)
%              for temp_0301=right_Brachial_Point(length(right_Brachial_Point))+50:right_Brachial_Point(length(right_Brachial_Point))+110
%                 temp_sum=0;
%                 for kkk=-30:30 
%                 if(data(temp_0301)>=data(temp_0301+kkk))
...
%         if((count==1)&&(i+30>right_Brachial_Point(length(right_Brachial_Point))+110)&&(i+30<2*right_Brachial_Point(length(right_Brachial_Point))+110-right_Brachial_Point(length(right_Brachial_Point)-1)))
%            right_Brachial_Point=[right_Brachial_Point,round((i+30+right_Brachial_Point(length(right_Brachial_Point)))/2)];
%            right_Brachial_Point=[right_Brachial_Point,i+30];
%         end
%         if((count==1)&&(i+30>2*right_Brachial_Point(length(right_Brachial_Point))+110-right_Brachial_Point(length(right_Brachial_Point)-1)))
...
plot(right_Brachial_Point,beifen_data(right_Brachial_Point),'ro')  ;            %% 绘制波谷点
...
% if(PeakNum(1)<=PeakNum(3))    
     for i=1:min([PeakNum(1),PeakNum(3)])-1                                                             %%左侧              %%另外一种计算PPTT的方式
...
for i=1:min([PeakNum(2),PeakNum(4)])-1                                                                                        %%右侧              %%另外一种计算PPTT的方式
...
plot(left_Ankle_Point+1,'r') ;                                                                       %%%特征点序列  
